...
function budgetCurrencyTable(budget) {
...
export async function handler(event) {
  ...
  if (!GMAIL_USER || !GMAIL_PASS) {
    return { statusCode: 500, body: JSON.stringify({ success: false, error: "Email credentials not configured" }) };
  }
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td align="center" style="background:#eff6ff;border:1px solid #93c5fd;border-radius:12px;padding:20px 16px;">
                        ...
                        <p style="margin:0;font-size:13px;font-weight:700;color:#1e293b;font-family:Arial,sans-serif;">${data.timeline || "Not specified"}</p>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#ecfdf5;border:1px solid #6ee7b7;border-radius:14px;margin-bottom:32px;">
              <tr>
                <td style="padding:18px 20px;">
                  <p style="margin:0 0 12px 0;font-size:11px;font-weight:700;color:#065f46;letter-spacing:2px;text-transform:uppercase;text-align:center;font-family:Arial,sans-serif;">💰 Budget Range</p>
                  ${budgetCurrencyTable(data.budget || "Negotiable")}
                </td>
              </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
              <tr>
                <td style="background:#faf5ff;border:1px solid #e9d5ff;border-radius:14px;padding:24px;">
                  <p style="margin:0;font-size:14px;color:#334155;line-height:1.8;white-space:pre-wrap;word-break:break-word;font-family:Arial,sans-serif;">${data.description || "No description provided"}</p>
                </td>
              </tr>
            </table>
      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#ffffff;padding:36px 32px;">
            ...
            <p style="margin:0 0 28px 0;font-size:15px;color:#64748b;line-height:1.8;font-family:Arial,sans-serif;">Thank you for your interest in working with me! I've received your project inquiry and I'm genuinely excited to learn more. I'll carefully review all your details and reach out with a personalized proposal within <strong>24 hours</strong>.</p>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
                    <tr>
                      <td width="36" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td align="center" width="28" height="28" style="background:linear-gradient(135deg,#6366f1,#7c3aed);border-radius:50%;width:28px;height:28px;"><p style="margin:0;font-size:12px;font-weight:700;color:#ffffff;line-height:28px;font-family:Arial,sans-serif;">1</p></td></tr></table>
                      </td>
                      <td valign="middle" style="padding-left:12px;"><p style="margin:0;font-size:14px;color:#334155;line-height:1.6;font-family:Arial,sans-serif;"><strong>Review</strong> — I'll review your project description and requirements in detail.</p></td>
                    </tr>
                  </table>
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
                    <tr>
                      <td width="36" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td align="center" width="28" height="28" style="background:linear-gradient(135deg,#6366f1,#7c3aed);border-radius:50%;width:28px;height:28px;"><p style="margin:0;font-size:12px;font-weight:700;color:#ffffff;line-height:28px;font-family:Arial,sans-serif;">2</p></td></tr></table>
                      </td>
                      <td valign="middle" style="padding-left:12px;"><p style="margin:0;font-size:14px;color:#334155;line-height:1.6;font-family:Arial,sans-serif;"><strong>Proposal</strong> — I'll prepare a customized proposal with timeline and cost breakdown.</p></td>
                    </tr>
                  </table>
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:14px;">
                    <tr>
                      <td width="36" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td align="center" width="28" height="28" style="background:linear-gradient(135deg,#6366f1,#7c3aed);border-radius:50%;width:28px;height:28px;"><p style="margin:0;font-size:12px;font-weight:700;color:#ffffff;line-height:28px;font-family:Arial,sans-serif;">3</p></td></tr></table>
                      </td>
                      <td valign="middle" style="padding-left:12px;"><p style="margin:0;font-size:14px;color:#334155;line-height:1.6;font-family:Arial,sans-serif;"><strong>Connect</strong> — We'll schedule a call to discuss the project and align on expectations.</p></td>
                    </tr>
                  </table>
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="36" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0"><tr><td align="center" width="28" height="28" style="background:linear-gradient(135deg,#6366f1,#7c3aed);border-radius:50%;width:28px;height:28px;"><p style="margin:0;font-size:12px;font-weight:700;color:#ffffff;line-height:28px;font-family:Arial,sans-serif;">4</p></td></tr></table>
                      </td>
                      <td valign="middle" style="padding-left:12px;"><p style="margin:0;font-size:14px;color:#334155;line-height:1.6;font-family:Arial,sans-serif;"><strong>Build</strong> — Once agreed, I'll start building your vision with regular progress updates.</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
        ...
        <tr>
          <td align="center" style="background:#f8faff;border:1px solid #e0e7ff;border-radius:0 0 20px 20px;padding:24px 32px;">
            ...
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding:0 8px;"><a href="https://linkedin.com/in/shree-bhargav-r-k-7b5b1419b" style="font-size:12px;color:#6366f1;font-weight:600;text-decoration:none;font-family:Arial,sans-serif;">LinkedIn</a></td>
                <td style="padding:0 8px;"><a href="https://github.com/rkshree001" style="font-size:12px;color:#6366f1;font-weight:600;text-decoration:none;font-family:Arial,sans-serif;">GitHub</a></td>
              </tr>
            </table>
          </td>
        </tr>
